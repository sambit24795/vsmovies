...
export class HelloWorldPanel {
  ...
  public static currentWindow: vscode.Webview;
  ...
  private async _update() {
    ...
    HelloWorldPanel.currentWindow = webview;
 ...
 */
    ...
    <head>
      ...
      -->
      <meta http-equiv="Content-Security-Policy" content="default-src *; img-src * 'self' data:; style-src 'unsafe-inline' ${
        webview.cspSource
